...
namespace ProductManagement.Data
{
    public class ProductManagementDataSeedContributor : IDataSeedContributor, ITransientDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            await _categoryRepository.InsertManyAsync([monitors, printers], autoSave: true);
            ...
            await _productRepository.InsertManyAsync([monitor1, monitor2, printer1], autoSave:true);
        }
    }
}